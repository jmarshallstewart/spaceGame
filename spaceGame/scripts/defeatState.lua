...
function DefeatState_Start()
   defeatState.bigFont = LoadFont("spaceGame/8_bit_pusab.ttf", defeatState.bigFontSize)
   defeatState.font = LoadFont("spaceGame/8_bit_pusab.ttf", defeatState.fontSize)
   defeatState.prevDownButton7 = controller_0_button_7
   defeatState.music = LoadMusic("spaceGame/music/ending.ogg")
