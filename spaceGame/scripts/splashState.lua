...
function SplashState_Start()
   splashState.bigFont = LoadFont("spaceGame/8_bit_pusab.ttf", splashState.bigFontSize)
   splashState.font = LoadFont("spaceGame/8_bit_pusab.ttf", splashState.fontSize)
   splashState.music = LoadMusic("spaceGame/music/title.ogg")
